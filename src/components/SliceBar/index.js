...
import { AntDesign, Ionicons, FontAwesome,Feather,Entypo, MaterialIcons} from '@expo/vector-icons';
        ...
        <View style={styles.root}>
            <DrawerContentScrollView {...props}>
                <View style={styles.container}>
                    ...
                    <Text style = {styles.text}>Powered by <Text style={styles.textup}>UpNow</Text></Text>
                </View>

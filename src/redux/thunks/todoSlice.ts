...
export const getTodo = createAsyncThunk('GET_TODO', async () => {
  const res = await axios.get('https://62ea39ebad295463258761d5.mockapi.io/blogs')
  return res.data
})

export const addTodo = createAsyncThunk('ADD_TODO', async (newTodo) => {
  const res = await axios.post(`https://62ea39ebad295463258761d5.mockapi.io/blogs`,
  {
      id: newTodo.id,
      title: newTodo.title,
...
export const updatedTodo = createAsyncThunk('UPDATE_TODO', async (updateTodo) => {
  const res = await axios.put('https://62ea39ebad295463258761d5.mockapi.io/blogs/' + updateTodo.id,
  {
...
export const deletedTodo = createAsyncThunk('DELETE_TODO', async (removeTodo) => {
  const res = await axios.delete(`https://62ea39ebad295463258761d5.mockapi.io/blogs/` + removeTodo.id,);
  return res.data
})
